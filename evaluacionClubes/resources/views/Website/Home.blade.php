...
@section('content')
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-6 wow fadeInLeft" data-wow-delay=".9s">
          ...
          <img src="/assets/app/images/page-1_img1.png" alt=""/>
          <h5 class="ins_r">
            Project
            Management
          </h5>
        ...
        <div class="col-md-3 col-sm-6 col-xs-6 wow fadeInLeft" data-wow-delay=".7s">
          ...
          <img src="/assets/app/images/page-1_img2.png" alt=""/>
          <h5 class="ins_r">
            Building
            Innovation
          </h5>
        ...
        <div class="col-md-3 col-sm-6 col-xs-6 wow fadeInLeft" data-wow-delay=".5s">
          ...
          <img src="/assets/app/images/page-1_img3.png" alt=""/>
          <h5 class="ins_r">
            Inspection
            & Testing
          </h5>
        ...
        <div class="col-md-3 col-sm-6 col-xs-6 wow fadeInLeft" data-wow-delay=".3s">
          ...
          <img src="/assets/app/images/page-1_img4.png" alt=""/>
          <h5 class="ins_r">
            New
            Technologies
          </h5>
  ...
  <section class="well well2 parallax text-center" data-url="/assets/app/images/parallax1.jpg" data-mobile="true"
           data-speed="0.6">
    <div class="container">
      <h2 class="fw-l">
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 wow fadeInRight" data-wow-delay=".7s">
          <div class="thumbnail thumbnail4">
            <img src="/assets/app/images/page-1_img5.jpg" alt="">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 wow fadeInRight" data-wow-delay=".5s">
          <div class="thumbnail thumbnail4">
            <img src="/assets/app/images/page-1_img6.jpg" alt="">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 wow fadeInRight" data-wow-delay=".3s">
          <div class="thumbnail thumbnail4">
            <img src="/assets/app/images/page-1_img7.jpg" alt="">
  ...
  <section class="well well4 parallax text-center" data-url="/assets/app/images/parallax2.jpg" data-mobile="true"
           data-speed="0.6">
    <div class="container">
      <h2>
        We are ready to satisfy<br/>
